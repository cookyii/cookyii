...
class UserController extends \yii\rest\ActiveController
{
    ...
    public function actions()
    {
        ...
        $actions['edit'] = [
            'class' => Account\backend\controllers\rest\UserController\EditFormAction::className(),
            'modelClass' => $this->modelClass,
            'checkAccess' => [$this, 'checkAccess'],
        ];

        $actions['roles'] = [
            'class' => Account\backend\controllers\rest\UserController\RolesAction::className(),
            'modelClass' => $this->modelClass,
            'checkAccess' => [$this, 'checkAccess'],
        ];

        $actions['detail'] = [
            'class' => Account\backend\controllers\rest\UserController\DetailAction::className(),
            'modelClass' => $this->modelClass,
            'checkAccess' => [$this, 'checkAccess'],
        ];
